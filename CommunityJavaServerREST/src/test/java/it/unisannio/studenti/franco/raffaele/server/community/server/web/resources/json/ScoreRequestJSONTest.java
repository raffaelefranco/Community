...
class ScoreRequestJSONTest {
	...
	static ScoreRequestJSON scoreResponseJSON = new ScoreRequestJSON();
	...
	void scoreQuestionTest() {
		String request = gson.toJson("Text1" + ";" + "10");

		try {
			scoreResponseJSON.scoreQuestion(request);
			assertTrue(true);

...
public class LoginActivityTest2 {
    ...
    public void loginActivityTest2() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.username1),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("luca"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("luc"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.username), withText("luc"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("luchino"));

        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.username), withText("luchino"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("luca"), closeSoftKeyboard());

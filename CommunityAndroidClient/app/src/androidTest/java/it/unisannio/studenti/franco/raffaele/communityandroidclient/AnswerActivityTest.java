...
public class AnswerActivityTest {
    ...
    @Test
    public void answerActivityTest() {
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.title),
                        childAtPosition(
                                ...
                                4),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("What team has won the last Premier League"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText6 = onView(
                allOf(withId(R.id.text),
                        childAtPosition(
                                ...
                                5),
                        isDisplayed()));
        appCompatEditText6.perform(replaceText("I forgot"), closeSoftKeyboard());

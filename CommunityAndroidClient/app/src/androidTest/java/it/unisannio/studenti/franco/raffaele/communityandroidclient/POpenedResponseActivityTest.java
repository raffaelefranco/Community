...
public class POpenedResponseActivityTest {

    @Rule
    public ActivityTestRule<MainActivity> mActivityTestRule = new ActivityTestRule<>(MainActivity.class);

    @Test
    public void votoRispostaActivityTest() {
        ...
        ViewInteraction textView3 = onView(
                allOf(withId(R.id.textView_username_req1), withText("maria"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                0),
                        isDisplayed()));
        textView3.check(matches(withText("maria")));
        ...
        ViewInteraction textView4 = onView(
                allOf(withId(R.id.textView_username_req1), withText("maria"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView4.check(matches(withText("maria")));
    }

...
public class LoginActivityTest7 {
    ...
    public void loginActivityTest7() {
        ...
        ViewInteraction editText3 = onView(
                allOf(withId(R.id.username), withText("luigi"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
                                1),
                        isDisplayed()));
        editText3.check(matches(withText("luigi")));
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.username),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("luigi"), closeSoftKeyboard());

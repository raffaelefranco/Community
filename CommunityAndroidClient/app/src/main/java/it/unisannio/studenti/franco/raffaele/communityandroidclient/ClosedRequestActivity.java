...
public class ClosedRequestActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_closed_request);

        preferences = getSharedPreferences(prefName, MODE_PRIVATE);
        list = (ListView) findViewById(R.id.clo_req_list);

        new ClosedRequestActivity.ClosedReqRestTask().execute();

        list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(ClosedRequestActivity.this, ViewClosedRequestActivity.class);
    ...
    public class ClosedReqRestTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            ...
            String URI = baseURI + "closed_requests/" + username;
